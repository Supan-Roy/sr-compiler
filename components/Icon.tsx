...
type IconType = 'run' | 'format' | 'clear' | 'chevronDown' | 'logo' | 'terminal' | 'input' | 'copy' | 'check' | 'fontSize' | 'spinner' | 'code' | 'settings' | 'share' | 'upload' | 'download' | 'sun' | 'moon' | 'target' | 'cross' | 'menu' | 'close' | 'eye' | 'eye-off';
